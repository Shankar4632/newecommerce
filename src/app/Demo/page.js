            ...
            {/* <div>
              ...
              {isOpen && (
                ...
                >
                  ...
                  <li style={{ padding: "5px" }}>Stories</li>
                  <li style={{ padding: "5px" }}>Artisans</li>
                  <li style={{ padding: "5px" }}>Boutiques</li>
                  <li style={{ padding: "5px" }}>Contact Us</li>
                  <li style={{ padding: "5px" }}>EU Compliances Docs</li>
                </ul>
              )}
            </div>
            <div>
              ...
              {isOpen && (
                ...
                >
                  <li style={{ padding: "5px" }}>Join/Login as a Seller</li>
                  <li style={{ padding: "5px" }}>Payment & Pricing</li>
                  <li style={{ padding: "5px" }}>Return & Refundss</li>
                  <li style={{ padding: "5px" }}>FAQs</li>
                  <li style={{ padding: "5px" }}>Privacy Policy</li>
                  <li style={{ padding: "5px" }}>Terms & Conditions</li>
                </ul>
              )}
            </div> */}
            <Dropdown
